        ...
        <div class="page" style="width: 100%;">
            ...
            <div class="container-fullw">
                <div class="panel-body no-padding" style="border: 1px solid green;">
                    ...
                    <form method="POST" id="GreenConditionFrom" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="Cond" name="cond" value="green">
                            </div>
                        </div>
...
<script>
    $("#GreenConditionFrom").submit(function(e) {
        e.preventDefault();
        $('#Nameerror').html("");
        $('#Surnameerror').html("");
        $('#IDerror').html("");
        ...
        var myform = document.getElementById("GreenConditionFrom");

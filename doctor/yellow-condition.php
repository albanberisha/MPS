                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <select name="PatientRoom" class="form-control patient-room" required="true">
                                <option selected="">14 Dhoma 3 Departamenti i Urgjences</option>
                                <option>13 Dhoma 3 Departamenti i Urgjences</option>
                                <option>24 Dhoma 7 Departamenti i Urgjences</option>

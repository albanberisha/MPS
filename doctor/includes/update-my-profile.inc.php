...
function lookotherElements($con,$docphoto)
{
    ...
    $id=$_SESSION['id'];
    $u_name = $_POST['nameDoc'];
    $u_surname = $_POST['surnameDoc'];
    $u_birthday = $_POST['Docstart_date'];
    $u_gender = $_POST['docgender'];
    $u_state = $_POST['stateaddress'];
    $u_city = $_POST['cityaddress'];
    $u_street = $_POST['streetAddress'];
    $u_phone = $_POST['docPhone'];
    $u_email = $_POST['docemail'];
    $u_username = $_POST['docusername'];
    $u_oldadminpsw = $_POST['olddocpassword'];
    $u_adminpsw = $_POST['docpassword'];
    $u_confpsw = $_POST['docconfirm_password'];

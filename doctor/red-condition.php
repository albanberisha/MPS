...
<head>
    <title>Doktor | Regjistrim i pacientëve</title>
        ...
        <div class="page" style="width: 100%;">
            ...
            <div class="container-fullw">
                <div class="panel-body no-padding" style="border: 1px solid red;">
                    ...
                    <form method="POST" id="RedConditionFrom" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="PatientRoom" class="form-control patient-room">
                                ...
                                <?php
                                $query = mysqli_query($con, "SELECT beds.id as bedid, rooms.id as roomid, departaments.id as depid, departaments.depname FROM beds, rooms, departaments WHERE rooms.id=beds.roomId and rooms.depId=departaments.id and (beds.bedstatus=1 and rooms.roomstatus=1 and departaments.depname like '%mergjenc%' and departaments.depstatus=1) and patientId is NULL");
                                if (!$query) {
...
<script>
    $("#RedConditionFrom").submit(function(e) {
        e.preventDefault();
        $('#Nameerror').html("");
        $('#Surnameerror').html("");
        $('#IDerror').html("");
        ...
        var myform = document.getElementById("RedConditionFrom");

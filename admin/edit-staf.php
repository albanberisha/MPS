            ...
            <div class=" container-fullw">
                <div class="panel-body">
                    <div class="panel-heading">
                        <h5 class="panel-title">Shani Bujupaj</h5>
                        ...
                        <form>
                            ...
                            <div class="div-inlineflex">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nametaf" class="form-control" placeholder="Sheno emrin" value="Shani">
                                </div>
                                <div class="form-group">
                                    <label class="input-title">Mbiemri</label>
                                    <input type="text" id="surnameStaf" class="form-control" placeholder="Sheno mbiemrin" value="Bujupaj">
                                </div>
                            </div>
                            <div class="div-inlineflex">
                                <div class="form-group">
                                    <label class="input-title">Datelindja</label>
                                    <input type="date" class="form-control" id="Stafstart-date" name="stafstart_date" value="2018-07-22" />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="adressStaf" name="adressstaf" placeholder="Adresa" value="MAti1, Prishtina">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="Stafposition" class="form-control" required="true">
                                    ...
                                    <option selected>Sigurim</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" readonly="readonly" name="stafemail" placeholder="Emaili" value="Shani@gmail.com">
                            </div>

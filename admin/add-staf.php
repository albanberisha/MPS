        ...
        <div class="page" style="width: 100%;">
            ...
            <div class=" container-fullw">
                <div class="panel-body">
                    ...
                    <form method="POST" id="StafFrom" enctype="multipart/form-data">
                    <div class="circle form-group">
                            ...
                            <div class="div-inlineflex">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nameStaf" name="nameStaf" class="form-control" placeholder="Sheno emrin">
                                    <span id="Nameerror" style="color: red;"></span>
                                </div>
                                <div class="form-group">
                                    <label class="input-title">Mbiemri</label>
                                    <input type="text" id="surnameStaf" name="surnameStaf" class="form-control" placeholder="Sheno mbiemrin">
                            ...
                            <div class="div-inlineflex">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-title-btn">
                                        <input type="radio" name="stafgender" value="m" checked> Mashkull<br>
                            ...
                            <div class="form-group">
                                ...
                                <select name="Stafposition" class="form-control">
                                    ...
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM `hospital_additional_staff` ORDER BY name");
                                    if (!$query) {
                                        die("E pamundur te azhurohen te dhenat: " . mysqli_connect_error());
                                    } else {
                                        while ($data = mysqli_fetch_array($query)) {
                                    ?>
                                            <option value="<?php echo htmlentities($data['id']) ?>"><?php echo htmlentities($data['name']) ?></option>
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="staffemail" placeholder="Emaili">
...
<script>
    $("#StafFrom").submit(function(e) {
        ...
        var myform = document.getElementById("StafFrom");
    var fd = new FormData(myform );
    $.ajax({
        url: "includes/add-staff.inc.php",
        data: fd,
        cache: false,
        processData: false,
        contentType: false,
  ...
  case "2":
    ...
    case "11":
    $message="Zgjidhni njeren nga opsionet!";
    $('#Positionerror').html($message);
    document.getElementById('Positionerror').scrollIntoView({ behavior: 'smooth', block: 'center' });
    break;
    case "13":

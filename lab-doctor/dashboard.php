        ...
        <div class="page" style="width: 100%;">
            ...
            <div class="container-fullw">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="col">
                            <div class="panel panel-white text-center" onclick="window.open('results.php', 'mywindow');">
                    ...
                    <div class="col-sm-4">
                        <div class="col">
                        <div class="panel panel-white no-radius text-center" onclick="window.open('add-new-results.php', 'mywindow');">
                                <div class="panel-body wid">
                                    <div class="fa-stack fa-2x image-wid">
